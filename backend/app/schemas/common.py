...
# DistritoFiscal Schemas
class DistritoFiscalBase(BaseModel):
    nombre: str
    codigo: str
...
class DistritoFiscalCreate(DistritoFiscalBase):
    pass


class DistritoFiscalUpdate(BaseModel):
...
class DistritoFiscalResponse(DistritoFiscalBase):
    id: int
    created_at: datetime
