...
import MisProgramaciones from './components/solicitudes/MisProgramaciones';
...
import { DistritosFiscalesMantenimiento } from './components/mantenimientos/DistritosFiscalesMantenimiento';
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={[UserRole.ADMIN]}>
              <DistritosFiscalesMantenimiento />
            </ProtectedRoute>
          }
        />
