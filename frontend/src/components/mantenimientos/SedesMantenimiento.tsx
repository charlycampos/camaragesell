...
import { sedeService, distritoFiscalService } from '../../services/mantenimiento.service';
import { Sede, DistritoFiscal } from '../../types';
  ...
  const handleOpenModal = (sede?: Sede) => {
    if (sede) {
      ...
      setFormData({
        ...
        distrito_fiscal_id: sede.distrito_fiscal_id,
          ...
          <>
            <div className="table-container">
              <table className="data-table">
                ...
                <tbody>
                  {sedes.map((sede) => {
                    const distrito = distritos.find(d => d.id === sede.distrito_fiscal_id);
                    return (
                    <tr key={sede.id}>
