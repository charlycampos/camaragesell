...
import { despachoService, distritoFiscalService } from '../../services/mantenimiento.service';
import { DespachoFiscal, DistritoFiscal } from '../../types';
  ...
  const handleOpenModal = (despacho?: DespachoFiscal) => {
    if (despacho) {
      ...
      setFormData({
        ...
        distrito_fiscal_id: despacho.distrito_fiscal_id,
              ...
              <table className="data-table">
                ...
                <tbody>
                  {despachos.map((despacho) => {
                    const distrito = distritos.find(d => d.id === despacho.distrito_fiscal_id);
                    return (
                    <tr key={despacho.id}>
